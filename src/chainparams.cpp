...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (2365700, uint256S("b5d0beead57735539abc2db2b0b08cd65db3e5928efd3c3bf3182d5bf013f36c")) //!< CIRCUIT v4.1.1 enforced
...
public:
    CMainParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // CIRCUIT starting difficulty is 1 / 2^12
        ...
        // validation by-pass
        consensus.nCircuitBadBlockTime = 1471401614;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nCircuitBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
        ...
        vSeeds.emplace_back("circuit-society.io", "seed1.circuit-society.io", true);     // Primary DNS Seeder from Fuzzbawls
        vSeeds.emplace_back("circuit-society.io", "seed2.circuit-society.io", true);    // Secondary DNS Seeder from Fuzzbawls
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "crctks";
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("circuit-society.io", "circuit-testnet.seed.circuit-society.io", true);
        vSeeds.emplace_back("circuit-society.io", "circuit-testnet.seed2.circuit-society.io", true);
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "crctktestsapling";
