...
extern const char * const CIRCUIT_CONF_FILENAME;
extern const char * const CIRCUIT_PID_FILENAME;
extern const char * const CIRCUIT_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("circuit-%s", name);
