...
#error Client version information missing: version is not defined by circuit-config.h or in any other way
#endif
...
/**
 * circuitd-res.rc includes this file, but it cannot cope with real c++ code.
