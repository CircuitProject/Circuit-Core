...
/* Circuit GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "CIRCUIT"
#define QAPP_ORG_DOMAIN "circuit.org"
#define QAPP_APP_NAME_DEFAULT "CIRCUIT-Qt"
#define QAPP_APP_NAME_TESTNET "CIRCUIT-Qt-testnet"
