...
#ifndef CIRCUIT_CORE_NEW_GUI_CIRCUITGUI_H
#define CIRCUIT_CORE_NEW_GUI_CIRCUITGUI_H
...
#include "qt/circuit/navmenuwidget.h"
#include "qt/circuit/topbar.h"
#include "qt/circuit/dashboardwidget.h"
#include "qt/circuit/send.h"
#include "qt/circuit/receivewidget.h"
#include "qt/circuit/addresseswidget.h"
#include "qt/circuit/coldstakingwidget.h"
#include "qt/circuit/masternodeswidget.h"
#include "qt/circuit/snackbar.h"
#include "qt/circuit/settings/settingswidget.h"
...
/**
  CIRCUIT GUI main class. This class represents the main window of the CIRCUIT UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class CIRCUITGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit CIRCUITGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~CIRCUITGUI();
...
#endif //CIRCUIT_CORE_NEW_GUI_CIRCUITGUI_H
