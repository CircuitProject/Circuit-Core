...
#include "config/circuit-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalCrct = 0;
    qint64 totalZcrct = 0;
    QList<qreal> valuesCrct;
    QList<qreal> valueszCrct;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(CIRCUITGUI* _window);
    ~DashboardWidget();
