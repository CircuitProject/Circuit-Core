...
#include "qt/circuit/furabstractlistitemdelegate.h"
#include "qt/circuit/txviewholder.h"
#include "qt/circuit/tooltipmenu.h"
#include "qt/circuit/sendmultirow.h"
#include "qt/circuit/coldstakingmodel.h"
#include "qt/circuit/contactsdropdown.h"
#include "qt/circuit/addressholder.h"
...
public:
    explicit ColdStakingWidget(CIRCUITGUI* parent);
    ~ColdStakingWidget();
