...
#include "qt/circuit/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(CIRCUITGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &CIRCUITGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
