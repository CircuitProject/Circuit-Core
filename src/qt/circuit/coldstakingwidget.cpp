...
#include "qt/circuit/forms/ui_coldstakingwidget.h"
#include "qt/circuit/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/circuit/requestdialog.h"
#include "qt/circuit/tooltipmenu.h"
#include "qt/circuit/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(CIRCUITGUI* parent) :
    PWidget(parent),
