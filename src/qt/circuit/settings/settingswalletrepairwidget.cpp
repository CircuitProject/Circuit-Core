...
#include "qt/circuit/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/circuit/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(CIRCUITGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to CIRCUITGUI::handleRestart()
