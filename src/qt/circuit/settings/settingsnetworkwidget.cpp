...
#include "qt/circuit/settings/settingsnetworkwidget.h"
#include "qt/circuit/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/circuit/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(CIRCUITGUI* _window, QWidget *parent) :
