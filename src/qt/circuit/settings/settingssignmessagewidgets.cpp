...
#include "qt/circuit/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(CIRCUITGUI* _window, QWidget *parent) :
