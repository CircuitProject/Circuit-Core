...
#include "qt/circuit/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(CIRCUITGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("CIRCUIT_tx_csv_export(*.csv)") : tr("CIRCUIT_addresses_csv_export(*.csv)"),
                                        nullptr);
