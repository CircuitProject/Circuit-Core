...
#include "qt/circuit/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/circuit/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(CIRCUITGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableCRCT,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableCRCT,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableCRCT,
    ...
    connect(ui->pushButton_UnspendableCRCT, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableCRCT);});
    ...
    if (parent)
        connect(parent, &CIRCUITGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
