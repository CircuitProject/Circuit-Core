...
#include "qt/circuit/topbar.h"
#include "qt/circuit/forms/ui_topbar.h"
#include "qt/circuit/lockunlock.h"
#include "qt/circuit/qtutils.h"
#include "qt/circuit/receivedialog.h"
#include "qt/circuit/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/circuit/balancebubble.h"
...
TopBar::TopBar(CIRCUITGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopCrct, ui->labelAmountTopShieldedCrct}, "amount-small-topbar");
    setCssProperty({ui->labelAmountCrct}, "amount-topbar");
    setCssProperty({ui->labelPendingCrct, ui->labelImmatureCrct}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("CIRCUIT")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // CRCT Total
    QString totalCrct = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // CRCT
    // Top
    ui->labelAmountTopCrct->setText(totalTransparent);
    ui->labelAmountTopShieldedCrct->setText(totalShielded);
    // Expanded
    ui->labelAmountCrct->setText(totalCrct);
    ui->labelPendingCrct->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureCrct->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
