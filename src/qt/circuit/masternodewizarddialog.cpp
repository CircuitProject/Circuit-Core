...
#include "qt/circuit/forms/ui_masternodewizarddialog.h"

#include "activemasternode.h"
#include "optionsmodel.h"
#include "pairresult.h"
#include "qt/circuit/mnmodel.h"
    ...
    walletModel(model)
{
    ...
    if (walletModel->isRegTestNetwork()) {
        ui->lineEditPort->setText("51351");
    } else if (walletModel->isTestNetwork()) {
        ui->lineEditPort->setText("41350");
    } else {
        ui->lineEditPort->setText("31350");
    }
