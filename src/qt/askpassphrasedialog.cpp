...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            CIRCUITGUI* window = static_cast<CIRCUITGUI*>(parentWidget());
...
{
    CIRCUITGUI* gui = static_cast<CIRCUITGUI*>(parentWidget());
...
{
    hide();
    static_cast<CIRCUITGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("CIRCUIT will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your CRCTs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
