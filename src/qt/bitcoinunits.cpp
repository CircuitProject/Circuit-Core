...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(CRCT);
    unitlist.append(mCRCT);
    unitlist.append(uCRCT);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case CRCT:
        return QString("circuit");
    case mCRCT:
        return QString("mcircuit");
    case uCRCT:
        return QString::fromUtf8("ucircuit");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZcrct)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZCRCT)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZCRCT);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZCRCT)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZCRCT));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
