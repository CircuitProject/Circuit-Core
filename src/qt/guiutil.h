...
/** Utility functions used by the CIRCUIT Qt UI.
 */
namespace GUIUtil
{
...
// Render CIRCUIT addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZcrct = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZcrct = false);
...
// Parse "circuit:" URI into recipient object, return true on successful parsing
