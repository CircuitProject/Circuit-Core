...
class ListReceivedTest (CircuitTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 CRCT.
        ...
        # Send 1 CRCT to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 CRCT sending them all (fee is 0.1 CRCT)
        ...
        # Confirm transaction (2 CRCT from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 CRCT, send 0.6 CRCT + 0.05 CRCT fee
