...
"""Verify that starting circuit with -h works as expected."""
import subprocess

from test_framework.test_framework import CircuitTestFramework
from test_framework.util import assert_equal

class HelpTest(CircuitTestFramework):
    ...
    def run_test(self):
        self.log.info("Start circuit with -? for help text")
        ...
        self.log.info("Start circuit with -version for version information")
