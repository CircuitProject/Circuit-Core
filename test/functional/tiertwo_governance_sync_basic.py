...
from test_framework.test_framework import CircuitTier2TestFramework
...
class MasternodeGovernanceBasicTest(CircuitTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.circuit.org/t/test-proposal"
