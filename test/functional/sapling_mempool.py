#!/usr/bin/env python3
# Copyright (c) 2020 The CIRCUIT Core developers
...
class SaplingMempoolTest(CircuitTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 CRCT note to Alice
        ...
        # miner sends another 10 CRCT note to Alice
